...
function App(){
 ...
 return <div className="app">
  ...
  <main>
   ...
   {settings&&<section className="detail-card"><div className="detail-title"><b>設定</b><button onClick={()=>setSettings(false)}>閉じる</button></div><p>1570・日経平均・1360を監視します。市場データは自動更新されます。ジュニアはブラウザ標準の音声読み上げを利用します。</p></section>}
