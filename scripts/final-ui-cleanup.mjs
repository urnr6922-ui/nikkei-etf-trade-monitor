...
// Expand the local searchable catalog. These codes also have market-data files generated in CI,
// so selecting one uses the same live-data path as 1570/1360.
...
console.log('final UI cleanup applied: Nikkei reference, expanded searchable catalog, market-connected additions, and manual deletion')
